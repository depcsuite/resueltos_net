...
{
    /// <inheritdoc />
    public partial class LibrosMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibrosDetalles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Libros_LibrosDetalles_DetallesId",
                        column: x => x.DetallesId,
                        principalTable: "LibrosDetalles",
                        principalColumn: "Id",
