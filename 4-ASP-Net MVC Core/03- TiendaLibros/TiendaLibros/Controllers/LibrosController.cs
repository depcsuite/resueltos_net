...
namespace TiendaLibros.Controllers
{
    ...
    {
        private static LibrosDBContext _dbContext;
        ...
        private static LibroDto GetLibroByIsbn(string isbn)
        {
            ...
            var librosDto = LibrosMapper.Map(libros);

            //Consulto por Id
            var libro = librosDto.Where(x => x.ISBN == isbn).FirstOrDefault();
        ...
        /// </summary>
        /// <returns></returns>
        private static List<Libro> GetLibrosDB()
        {
